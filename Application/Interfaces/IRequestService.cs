...
public interface IRequestService
{
    ...
    public Task<PagedResponse<GetRequestResponse>> GetAllAsync(int pageNumber, int pageSize, Guid userId);
    ...
    public Task MarkAsViewedAsync(Guid requestId, Guid userId);
    public Task CheckAndSendEmailAsync(Guid requestId, Guid userId, DateTime eventTime);
}